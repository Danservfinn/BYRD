...
def main():
    """Execute orphan node dump directly."""
    ...
    print("=" * 60)
    print("DIRECT ORPHAN DUMP - BYPASS MODE")
    print("=" * 60)
    print(f"URI: {uri}")
    ...
    # Prepare report
    reports_file = "orphans_dump.json"
    ...
    Path(reports_file).write_text(json_str)
    
    print(f"[+] Orphan data written to {reports_file}")

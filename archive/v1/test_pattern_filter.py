"""Test the demonstration pattern filter in seeker.py"""
import re

def _is_demonstration_pattern(description: str) -> bool:
    """
...
test_cases = [
    ...
    # Should NOT be filtered (False) - legitimate patterns
...
print("Testing demonstration pattern filter:")
print("=" * 60)
...
for test_input, expected in test_cases:
    result = _is_demonstration_pattern(test_input)
...
if failed == 0:
    print("\n\u2713 All tests passed! The demonstration pattern filter is working correctly.")
else:
